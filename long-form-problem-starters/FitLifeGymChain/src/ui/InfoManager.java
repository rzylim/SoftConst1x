...
public class InfoManager {
    ...
    private static final String SWEATY_HELLHOLE_GYM_COMMAND = "hellhole";
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '" + SWEATY_HELLHOLE_GYM_COMMAND + "' for Fitlife " + SWEATY_HELLHOLE_GYM_NAME);
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case PALM_LAKE_COMMAND:
                    ...
                    break;
                case SWEATY_HELLHOLE_GYM_COMMAND:
                    printGymInfo(chain.lookupGymByName(SWEATY_HELLHOLE_GYM_NAME));
                    break;
