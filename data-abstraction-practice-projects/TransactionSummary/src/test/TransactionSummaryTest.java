...
public class TransactionSummaryTest {
    ...
    public void testAverageTransactionCost() {
        ...
        assertEquals(testSummary.averageTransactionCost(), (10.0 + 20 + 40 + 150 + 11 + 40 + 5)/7, 0.05);
    }
    ...
    @Test
    public void testspecificTypeAverageNonePresent() {
        TransactionSummary noneSummary = new TransactionSummary("test");
        noneSummary.addTransaction(t1);
        noneSummary.addTransaction(t2);
        noneSummary.addTransaction(t3);

        assertEquals(0, noneSummary.specificTypeAverage(EDUCATION), 0.05);
    }
